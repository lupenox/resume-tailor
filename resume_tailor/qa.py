...
def _probe_gemma_local() -> InitialQAProviderOption:
    from .ollama_transport import run_ollama_request
...
def _invoke_gemma_qa(
    *,
    ...
    from .ollama_transport import run_ollama_request
    from .ollama_writer import validate_ollama_model_name
...
def _invoke_grok_qa(
    *,
    ...
    from .grok_analysis import grok_analysis_args, resolve_grok_executable
...
def _invoke_antigravity_qa(
    *,
    ...
    from .antigravity_response import locate_stream_json_terminal, parse_stream_json_events
