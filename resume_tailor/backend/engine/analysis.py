...
ANALYSIS_PROVIDERS = ("gemma_local", "codex", "grok_cli", "antigravity")
...
_PROVIDER_WORKFLOW_LABELS = {
    ...
    "antigravity": "Antigravity analysis",
}
...
def invoke_analysis(
    *,
    ...
    if selected == "grok_cli":
        from resume_tailor.backend.providers.grok_analysis import invoke_grok_analysis
    ...
    if selected == "antigravity":
        from resume_tailor.backend.providers.antigravity_analysis import invoke_antigravity_analysis

        return invoke_antigravity_analysis(
            extracted_resume=extracted_resume,
            job_description=job_description,
            job_requirements=job_requirements,
            company=company,
