...
from resume_tailor.backend.utils.utilities import flatten_strings, normalized_text
...
def resolve_analysis_evidence(
    ...
    from resume_tailor.backend.jobs.job_requirements import job_requirement_index
