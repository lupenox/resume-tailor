...
from resume_tailor.backend.utils.utilities import InputError, atomic_write_json, sha256_file, utc_now_iso
    ...
    *,
    ...
    if isinstance(manifest, dict):
        ...
        if manifest.get("version") == 2:
            ...
            from resume_tailor.backend.jobs.job_requirements import validate_job_requirement_catalog
...
def _validated_antigravity_reprocess_payloads(
    ...
    *,
    ...
    from resume_tailor.backend.providers.antigravity_writer import resolve_tailoring_response_text_with_envelope
